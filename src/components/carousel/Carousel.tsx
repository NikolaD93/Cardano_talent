        ...
        <div className="embla__container">
          {team.map((item) => (
            <div className="embla__slide" key={item.id}>
              <CardContainer>
                <CardBody className="border border-white/20 rounded-md p-6 w-[90%] md:w-full relative transition duration-300 hover:shadow-[0px_26px_46px_-35px_rgba(4,79,200,0.67)] hover:shadow-[0px 22px 37px -11px rgba(4,79,200,0.91)]">
